...
import { Bell, CheckCircle, XCircle, Clock, Eye, Trash2, RefreshCw, BookOpen } from 'lucide-react';
  ...
  const getNotificationBadge = (type: string, title: string) => {
    ...
    if (type === 'new_book') {
      return (
        <Badge
          variant="default"
          className="bg-purple-500 hover:bg-purple-600 text-white border-purple-600 text-xs"
        >
          كتاب جديد
        </Badge>
      );
