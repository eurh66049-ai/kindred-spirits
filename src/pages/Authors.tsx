  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEOHead
        ...
        description="تصفح قائمة المؤلفين وأعمالهم في منصة كتبي. اكتشف كتب مؤلفيك المفضلين واقرأ أحدث إصداراتهم مجاناً."
        keywords="مؤلفون عرب, كتاب عرب, أدباء عرب, منصة كتبي, كتب المؤلفين"
