...
const Index = () => {
  ...
  const getSEOData = () => {
    let title = "منصة كتبي | مكتبتك الرقمية العربية المجانية - آلاف الكتب والروايات";
    let description = "منصة كتبي - أكبر مكتبة رقمية عربية مجانية. اكتشف أكثر من 1000 كتاب في الأدب والروايات والتنمية البشرية والتاريخ والعلوم. قراءة وتحميل فوري بجودة عالية.";
    let keywords = "منصة كتبي, كتب عربية مجانية, مكتبة رقمية عربية, تحميل كتب PDF, روايات عربية, كتب أدبية, تنمية بشرية, كتب إلكترونية مجانية";
            ...
            <div className="inline-block">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {[
                  ...
                  <span key={i}
                    className="px-4 py-2 text-sm rounded-full backdrop-blur-sm hover:scale-105 transition-transform"
                    style={{ 
                      background: 'linear-gradient(135deg, rgba(255,200,50,0.1) 0%, rgba(255,150,30,0.08) 100%)',
