...
const UserProfile: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col bg-background">
        <SEOHead
          title="حسابي - منصة كتبي"
          description="إدارة حسابك وإعداداتك الشخصية على منصة كتبي. قم بتعديل ملفك الشخصي وتفضيلاتك."
          keywords="حسابي, الملف الشخصي, إعدادات الحساب, منصة كتبي"
          canonical="https://kotobi.xyz/profile"
          noindex={true}
        />
        ...
        <main className="flex-grow flex items-center justify-center bg-background">
          <div className="text-center">
            ...
            <p className="text-foreground font-tajawal font-black animate-pulse">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {/* شريط سفلي شفاف + blur (مهم للموبايل) */}
      <div
        className="
