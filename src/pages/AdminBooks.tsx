...
import { Loader2, CheckCircle, XCircle, Eye, AlertTriangle, Settings, RefreshCw, Calendar, User, BookOpen, FileText, Globe, Building, Search } from 'lucide-react';
  ...
  const fetchBookSubmissions = async (status: string) => {
    ...
    try {
      ...
      // للحالات المسموحة (pending/rejected)، نجلب من جدول book_submissions
        ...
        const { data: submissions, error } = await supabase.functions.invoke('get-book-submissions', {
          body: { status }
        });
