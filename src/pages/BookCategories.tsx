...
const BookCategories: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEOHead
        title="أقسام الكتب - منصة كتبي"
        description="تصفح الكتب حسب الأقسام المختلفة في منصة كتبي، واكتشف أفضل الكتب في كل تصنيف."
        keywords="أقسام الكتب, تصنيفات الكتب, مكتبة رقمية, منصة كتبي"
