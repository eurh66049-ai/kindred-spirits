...
const EMAILJS_SERVICE_ID = Deno.env.get('EMAILJS_SERVICE_ID') || 'service_n6xjylk';
const EMAILJS_TEMPLATE_ID = Deno.env.get('EMAILJS_EDIT_APPROVAL_TEMPLATE_ID') || 'template_pw9zmbt';
const EMAILJS_PUBLIC_KEY = Deno.env.get('EMAILJS_PUBLIC_KEY') || 'n_rmkh34qIbEpMHZD';
